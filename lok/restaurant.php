...
<body>
    <section class="lok">
        ...
        <div class="container-fluid menu" style="background-color:#161616">
            <div class="container  ">
                <a class="navbar-brand " href="anasayfa" style="display: block; text-align: center; right:43%; top:6%; position:absolute;"><img src="resim/logo.png" style="width:230px; height:140px; "></a>
    ...
    <section class="container-fluid orta " style="height:auto; background-color:#090909;">
    ...
    {?>
                <div class="card col-md-4 pb-3 mr-3" style="auto;">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $uruncek['sehir'] ?></h5>
                        <img src="Admin/images/logo/<?php echo $uruncek['sehir_resmi'] ?>" style="width:250px; height:300px;">
                        <a href="rezervasyon" class="card-link " style="color:brown; font-weight: 700;">Rezervasyon yap</a>
                        <a href="#" class="card-link " style="color:black; font-weight:700;">Detaylı Bilgi</a>
                    </div>
                </div>
